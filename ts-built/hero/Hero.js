...
exports.Hero = void 0;
const hero_utils_1 = require("../utility/hero.utils");
const Utility_1 = require("../utility/Utility");
// import { StatsManager } from './fightStatsManager';
class Hero {
    constructor() {
        this.isDead = false;
        this.coords = { x: 0, y: 0, xCoord: 0, yCoord: 0 }; //x-y son col-row. xCoord-yCoord son pixeles desplazados.
        ...
        this.calcNextTurn = (att_intervalEf = 0) => {
        ...
        this.asignCoords = (c) => {
            this.coords = Object.assign({}, c);
        };
        let newData = (0, hero_utils_1.createRandomStats)();
